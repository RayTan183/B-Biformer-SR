...
class OSAG(nn.Module):
    def __init__(self, channel_num=64, bias = True, block_num=1,ffn_bias=True,window_size=8,pe=True,block_script_name='OSA',block_class_name='OSA_Block'):
        ...
        script_name     = "models.OmniSR.ops." + block_script_name
